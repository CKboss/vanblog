...
export default {
  ...
  // ── 🔴 期 5 第十批（36 條）── 術語：**歷史版本** / **還原**（恢复，与回收站那批一致）/ **儲存**（保存）/
  //    伺服器 / 載入 / 權限 / 登入 / 字數 / 來源 / 無標題 / 保留策略 / 重新整理（刷新）/ 目前（当前）/ 支援（支持）。
  'revision.needArticleId': '文章還沒有儲存過（缺少 ID），儲存後再來查看歷史版本。',
  'revision.detailMissingId': '這個版本缺少 ID，無法查看',
  'revision.restoreMissingId': '缺少文章或版本 ID，無法還原',
  'revision.colSavedAt': '儲存時間',
  'revision.colWordCount': '字數',
  'revision.colReason': '來源',
  'revision.restoreOkBtn': '還原到這個版本',
  'revision.backToList': '返回列表',
  'revision.savedAt': '儲存於 {when}',
  'revision.wordCountValue': '字數 {count}',
  'revision.sizeValue': '大小 {size}',
  'revision.reasonValue': '來源 {reason}',
  'revision.title': '歷史版本',
  'revision.titleWithArticle': '歷史版本：{title}',
  'revision.loadingDetail': '正在載入版本內容…',
  'revision.featureOff': '版本歷史功能未開啟（伺服器 VANBLOG_ARTICLE_REVISIONS_KEEP=0，或 server 版本還不支援）。開啟後每次儲存文章都會自動記錄一個版本，超出保留上限的舊版本由伺服器自動清理。',
  'revision.empty': '這篇文章還沒有歷史版本。儲存文章時會自動記錄版本（保留條數上限由伺服器控制）；若伺服器未開啟版本歷史（VANBLOG_ARTICLE_REVISIONS_KEEP=0），這裡會一直為空。',
  'revision.detailEmptyContent': '（這個版本沒有正文內容）',
  'revision.reasonUpdate': '儲存更新',
  'revision.reasonPreRestore': '還原前自動儲存',
  'revision.untitled': '(無標題)',
  'revision.detailWrap': '（{message}）',
  'revision.listFailed': '歷史版本載入失敗{detail}，請稍後重試。',
  'revision.detailNotFound': '這個版本的內容拿不到（404）：可能剛被伺服器的保留策略清理掉，或它屬於另一篇文章；請重新整理列表確認。',
  'revision.detailFailed': '版本內容載入失敗{detail}，請稍後重試。',
  'revision.restoreNotFound': '找不到這個版本（404）：它可能已被伺服器的保留策略清理，或屬於另一篇文章；列表將重新整理為最新狀態。',
  'revision.restoreForbidden': '目前帳號沒有還原版本的權限（需要 article:update），請聯絡管理員。',
  'revision.restoreUnauthorized': '登入已失效，請重新登入後再試。',
  'revision.restoreFailed': '還原版本失敗{detail}，請稍後重試。',
  'revision.restoreConfirmTitle': '把文章還原到「{title}」這個版本嗎？',
  'revision.restoreConfirmContent': '還原前，伺服器會先把文章目前的狀態儲存成一個新的歷史版本，所以這次還原本身也是可撤銷的（之後可以再還原回現在的內容）。確認後用該版本的正文覆蓋文章目前正文。',
  'revision.restoreNotApplied': '伺服器報告這次還原沒有生效（restored=false），文章未變更；請重新整理列表後重試。',
  'revision.savedVersionWhen': '（{when} 儲存的版本）',
  'revision.restoreSnapshot': '還原前的目前內容已自動存為一個新的歷史版本，可再次還原回來。',
  ...
  // ── 🔴 期 6 第六批（82 條）── 地區用詞：**還原**（恢复）/ **伺服器** / **檔案** / **資料庫** / **帳號** /
  //    **預設** / **資訊** / **匯出·匯入** / **儲存** / **日誌** / **金鑰** / **簽章** / **示範站** / 清單 /
  //    **靜態檔案** / **縮圖** / **自訂頁面** / **存取統計** / **重新整理** / 異地 / 覆蓋 / **取代** /
  //    **不可復原** / **登入** / 驗證介面 / 產生 / **本機** / 相容 / **部落格** / **筆資料**（条数据）。
  'backup.compressorAuto': '自動（挑本機最強的）',
  'backup.compressorZstd': 'zstd -19 --long（最小且快，推薦）',
  'backup.compressorXz': 'xz -9e（體積接近，慢好幾倍）',
  'backup.compressorGzip': 'gzip -9（最相容，體積略大）',
  'backup.totalsSummary': '{documents} 筆資料 / {files} 個檔案 / {collections} 張表',
  'backup.dataFileName': '備份-{date}.json',
  'backup.exportFailed': '匯出失敗！',
  'backup.demoBlockedEdit': '示範站禁止修改此項！',
  'backup.fullBackupDoneTitle': '整站備份已產生',
  'backup.descFile': '檔案',
  'backup.descSize': '體積',
  'backup.sizePrefix': '（壓縮前 ',
  'backup.sizeSuffix': ' MB 靜態檔案）',
  'backup.descCompressor': '壓縮',
  'backup.descSeconds': '耗時',
  'backup.secondsValue': '{seconds} 秒',
  'backup.descTotals': '內容',
  'backup.descDatabases': '資料庫',
  'backup.dbEntry': '{name}（{count} 張表）',
  'backup.downloadFailed': '下載失敗！',
  'backup.sigDownloaded': '已下載 .sig：請把它和歸檔放進**同一個**異地副本；公鑰的權威副本要**離線**保存（密碼管理器/列印/另一台機器）',
  'backup.sigNeverSigned': '這份歸檔從沒被簽過（旁邊沒有 .sig）：不是下載失敗。要證明副本沒被換過，請在「簽章金鑰」裡產生金鑰後再備份',
  'backup.downloadSigFailed': '下載 .sig 失敗！',
  'backup.inspectNoManifest': '讀不出這個備份的清單！',
  'backup.manifestTitle': '備份清單：{name}',
  'backup.descCreatedAt': '產生時間',
  'backup.descCompressorMethod': '壓縮方式',
  'backup.descTotal': '合計',
  'backup.dbNamePrefix': '資料庫 {name}',
  'backup.staticTitle': '靜態檔案',
  'backup.staticEntry': '{folder}: {files} 個 / {mb} MB',
  'backup.inspectFailed': '讀取清單失敗！',
  'backup.restoreConfirmTitle': '確定用這個備份覆蓋目前站點嗎？',
  'backup.restoreConfirmOk': '我確定，還原',
  'backup.overwritePrefix': '將用 ',
  'backup.overwriteSuffix': ' 覆蓋：',
  'backup.overwriteDatabases': '資料庫全部集合（文章、草稿、分類、標籤、圖床記錄、設定、存取統計…）',
  'backup.overwriteWaline': 'waline 評論庫',
  'backup.overwriteStatic': '本機靜態檔案（圖床圖片與縮圖、附件、自訂頁面）',
  'backup.overwriteWarning': '目前資料會被取代且不可復原，建議先匯出一份目前的備份。',
  'backup.restoreRelogin': '還原完成後需要重新登入（登入狀態與 jwt 金鑰都來自備份）。',
  'backup.restoreFailedToast': '還原失敗！',
  'backup.restoreDoneTitle': '還原完成',
  'backup.restoreDoneSummary': '耗時 {seconds} 秒，備份產生於 {createdAt}',
  'backup.restoreDbLine': '{name}：{collections} 張表 / {documents} 筆',
  'backup.restoreStaticLine': '靜態檔案 {folder}：{files} 個',
  'backup.deletedToast': '已刪除',
  'backup.deleteFailed': '刪除失敗！',
  'backup.colName': '備份檔案',
  'backup.colFormat': '格式',
  'backup.actDownload': '下載',
  'backup.downloadSigBtn': '下載 .sig（離線簽章）',
  'backup.actSignature': '簽章',
  'backup.actManifest': '清單',
  'backup.actRestore': '還原',
  'backup.deleteConfirmTitle': '刪除這個備份檔案？',
  'backup.fullSectionTitle': '整站備份與還原',
  'backup.fullSectionHint': '一個壓縮包 = 整個部落格',
  'backup.includesPrefix': '包含',
  'backup.includesDatabases': '資料庫全部集合',
  'backup.includesDatabasesDetail': '（文章、草稿、分類、標籤、圖床記錄、設定、存取統計）、',
  'backup.includesAnd': '，以及',
  'backup.includesStatic': '本機靜態檔案',
  'backup.includesStaticDetail': '（圖床圖片與縮圖、附件、自訂頁面）。 拿這一個檔案就能在新機器上把部落格整體還原出來。',
  'backup.compressorNote': '壓縮格式預設自動挑本機最強的（一般是 zstd -19）；圖片本身已經是 WebP，所以整體壓縮率主要取決於資料庫部分。 歸檔存在伺服器的備份目錄裡（',
  'backup.archiveNoteBold': '不在靜態目錄，匿名下載不到',
  'backup.archiveNoteSuffix': '），下載走後台驗證介面。',
  'backup.formatLabel': '壓縮格式：',
  'backup.exportFullBtn': '匯出整站備份',
  'backup.restoreSecondsOnly': '耗時 {seconds} 秒。',
  'backup.restoreFailedTitle': '還原失敗',
  'backup.restoreIncomplete': '上傳成功但還原沒有完成，請看伺服器日誌。',
  'backup.uploadFailedFull': '{name} 上傳失敗！',
  'backup.uploadRestoreBtn': '上傳備份並還原',
  'backup.refreshBtn': '重新整理列表',
  'backup.fullEmpty': '還沒有整站備份，點上面的「匯出整站備份」產生一個',
  'backup.dataSectionTitle': '資料備份（僅資料庫記錄， JSON）',
  'backup.dataSectionNote': '注意：匯入不會覆蓋目前後台登入帳號。這種 JSON 匯入匯出「不包含圖片、附件和評論本身」，只含圖片記錄以便檢索。要連檔案一起備份，請用上面的「整站備份」。',
  'backup.demoBlockedReason': '因為有人在示範站首頁放黃色資訊，所以關了這個權限了。',
  'backup.uploadOkRefresh': '{name} 上傳成功! 稍後重新整理就生效了!',
  'backup.importAllBtn': '匯入全部資料',
  'backup.exportAllBtn': '匯出全部資料',
  'backup.includesWaline': 'waline 評論庫',
